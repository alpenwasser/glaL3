...
\begin{figure}[!htb]
    \resizebox{\textwidth}{!}{\input{images/schematic.tex}}
...
\begin{figure}[!htb]
    \resizebox{\textwidth}{!}{\input{images/versuchsanordnung-1.tex}}
    \caption{Versuchsanordnung}
    \label{fig:versuch:1}
\end{figure}
\begin{figure}[!htb]
    \resizebox{\textwidth}{!}{\input{images/versuchsanordnung-2.tex}}
    \caption{Versuchsanordnung}
    \label{fig:versuch:2}
\end{figure}
...
Die Messprotokolle sind in Anhang %TODO
zu finden.

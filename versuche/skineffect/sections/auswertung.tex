Dieser Abschnitt besch\"aftigt  sich prim\"ar mit den Fits  zu den Messpunkten
...
{% START A3 PAGES
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            ...
            Leitf\"ahigkeit des verwendeten Aluminiums liefert, wie im Listing
            in Tabelle \ref{tab:fitparams:alu:freq} gesehen werden kann.
        }
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            Radialer  Verlauf des  B-Feldes bei  $\SI{450}{\hertz}$. Es gelten
            die   gleichen  \"Uberlegungen   zu  den   Randeffekten  wie   bei
            $\SI{30}{\hertz}$.   Die  Phase  passt  nicht  ganz  optimal,  und
            der  erhaltene  Wert f\"ur  $\sigma_{Fit,\angle\hat{B}}$  (Tabelle
            \ref{tab:fitparams:alu:freq:high:exact}) liegt  einiges tiefer als
            die  bisher gesehenen  Werte.   M\"oglicherweise  ist dies  darauf
            zur\"uckzuf\"uhren,  dass   bei  diesem   Versuch  die   Phase  im
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            ...
            Spule mit eingef\"uhrtem Aluminium-Vollzylinder. F\"ur das Listing
            mit den Parametern siehe Tabelle \ref{tab:fitparams:alu:L}.
        }
        \label{fig:alu:freq:L}
        \resizebox{.95\textwidth}{!}{\input{plots-pgf/massive--alu--R.pgf}}
        \captionof{figure}{%
            \"Anderung    des   Ohm'schen    Widerstandes   von    Spule   mit
            eingef\"uhrtem   Aluminium-Vollzylinder. Listing   siehe   Tabelle
            \ref{tab:fitparams:alu:R}.}
...
{% START A3 PAGES
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            ...
            $\sigma_{Fit,|\hat{B}|}$ und $\sigma_{Fit,\angle\hat{B}}$ (Tabelle
            \ref{tab:fitparams:cu:freq:exact})  nicht stark  unterscheiden und
            beide auch nicht besonders  weit vom Literaturwert $\sigma_{Kuch}$
            entfernt liegen (insb. verglichen mit dem Aluminium-Vollzylinder).
        }
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            N\"aherungsl\"osung  basierend  auf  der  N\"aherung  f\"ur  tiefe
            Frequenzen f\"ur den Frequenzverlauf  des B-Feldes im Hohlzylinder
            (Kupfer). Es wurde nur  auf den Betrag gefittet  wegen der starken
            Abweichung  der Phase  von  den Messwerten,  daher lieferte  diese
            N\"aherung  ledliglich  einen  Wert   f\"ur  $\sigma$  in  Tabelle
            \ref{tab:fitparams:cu:freq:approx}.
        }
	...
	\begin{minipage}[t]{0.33\textwidth}
        ...
        \input{listings/hollow--cu--freq--approx2.tex}
	\end{minipage}%
	\begin{minipage}[t]{0.67\textwidth}
        \vspace{0pt}\raggedright
        \resizebox{.95\textwidth}{!}{\input{plots-pgf/hollow--cu--freq--approx2.pgf}}
        \captionof{figure}{%
            N\"aherungsl\"osung  f\"ur  den  Frequenzverlauf des  B-Feldes  im
            Hohlzylinder (Kupfer). Betrag  und Phase wurden  separat gefittet,
            daher   zwei   Werte   f\"ur  die   Leitf\"ahigkeit   in   Tabelle
            \ref{tab:fitparams:cu:freq:approx2}.
        }
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            \"Anderung  des   auf  den  Spulenstrom   normierten  magnetischen
            Flusses  innerhalb  des  Zylinders von  Spule  mit  eingef\"uhrten
            Kupfer-Hohlzylinder  \emph{Beachte:} Bei der  Phase wurden  in der
            Tat  sowohl die  exakte wie  auch die  gen\"aherte L\"osung  f\"ur
            numerische  Problemf\"alle geplottet,  sie  kommen einfach  direkt
            \"ubereinander zu liegen.
        }
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            N\"aherungsl\"osung  basierend  auf  der  N\"aherung  f\"ur  tiefe
            Frequenzen f\"ur den Frequenzverlauf  des B-Feldes im Hohlzylinder
            (rostfreier Stahl). Wie auch  bei der Tieffrequenzn\"aherung f\"ur
            Kupfer  wurde   lediglich  auf  den  Betrag   gefittet  und  daher
            ent\"ahlt  Tabelle  \ref{tab:fitparams:st:freq:approx}  nur  einen
            experimentellen Wert f\"ur $\sigma$.
        }
	...
	\begin{minipage}[t]{0.33\textwidth}
        ...
        \input{listings/hollow--st--freq--approx2.tex}
	\end{minipage}%
	\begin{minipage}[t]{0.67\textwidth}
        \vspace{0pt}
        \resizebox{.95\textwidth}{!}{\input{plots-pgf/hollow--st--freq--approx2.pgf}}
        \captionof{figure}{%
            N\"aherungsl\"osung  f\"ur  den  Frequenzverlauf des  B-Feldes  im
            Hohlzylinder  (rostfreier  Stahl). An Betrag und Phase wurde separat
            gefittet (Tabelle~\ref{tab:fitparams:st:freq:approx2})
        }
	...
	\begin{minipage}[t]{0.33\textwidth}
        ...
        Auch   beim   Stahlrohr  stellt   man   fest,   dass  die   N\"aherung
        f\"ur   numerische  Problemf\"alle   und   die   exakte  L\"osung   in
        \"ahnlicher  Manier   wie  beim  Kupferrohr  (siehe   Anmerkungen  auf
        Seite  \pageref{fig:cu:freq:phi})  \"ubereinstimmen  bzw.  voneinander
        abweichen.
	...
	\begin{minipage}[t]{0.67\textwidth}
        ...
        \captionof{figure}{%
            \"Anderung des auf den Spulenstrom normierten magnetischen Flusses
            innerhalb des  Zylinders von  Spule mit  eingef\"uhrten rostfreiem
            Stahl-Hohlzylinder.  \emph{Beachte:} Bei der  Phase wurden  in der
            Tat sowohl  die exakte wie  auch die gen\"aherte  f\"ur numerische
            Problemf\"alle  L\"osung  geplottet,  sie  kommen  einfach  direkt
            \"ubereinander zu liegen.
        }

...
title('Betrag des Magnetfelds in Zylinderspule mit Vollzylinder aus Aluminium, (Frequenz: 450 Hz, horizontal zentriert)',fontdict=font)
legend(fontsize=16)
subplot(2,1,2)
...
title('Phase des Magnetfelds in Zylinderspule mit Vollzylinder aus Aluminium (Frequenz: 450 Hz, horizontal zentriert)',fontdict=font)
legend(fontsize=16)
show()

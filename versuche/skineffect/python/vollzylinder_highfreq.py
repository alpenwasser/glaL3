...
axes1.set_xlim([rmin*0.9,rmax*1.1+2.5])
...
axes2.set_xlim([rmin*0.9,rmax*1.1+2.5])
...
# ---------------------------------------------------------#
np.savetxt('numpy-txt/massive--alu--high-freq--exact.txt',([sigma_abs,sigma_arg]))

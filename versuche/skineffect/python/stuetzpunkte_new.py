...
plot_1_title               = r"Vergleich St\"utzpunktformeln, effektiv abgedeckter Frequenzbereich:" + str(int(fmin)) + " Hz bis " + str(int(highest_frequency)) + " Hz, " + str(int(npts+1)) + " Punkte"
y_lim_low                  = -2
y_lim_high                 = npts + 2
x_lim_low                  = 0.67 * fmin
